...
if ((int)$estimate->quantity_discount_percent != 0) {
    $tbltotal .= '<tr>
        <td align="right" width="75%"><strong>' . _l('qty_discount') . '</strong></td>
        <td align="right" width="10%">' . $estimate->quantity_discount_percent . '%</td>
...
if ((int)$estimate->special_discount_percent != 0) {
    $tbltotal .= '<tr>
        <td align="right" width="75%"><strong>' . _l('special_discount') . '</strong></td>
        <td align="right" width="10%">' . $estimate->special_discount_percent . '%</td>
...
if ((int)$estimate->offer_discount_percent != 0) {
    $tbltotal .= '<tr>
        <td align="right" width="75%"><strong>' . _l('offer_discount') . '</strong></td>
        <td align="right" width="10%">' . $estimate->offer_discount_percent . '%</td>
...
<tr style="background-color:#f0f0f0;">
    ...
    <td align="right" width="15%">' . app_format_money($estimate->before_additional_discount_subtotal, $estimate->currency_name) . '</td>
</tr>';
