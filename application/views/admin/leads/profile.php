            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        ...
                        <dt class="lead-field-heading tw-font-medium tw-text-neutral-500">
                        <?php echo _l('lead_add_edit_nature_of_work'); ?></dt>
                    <dd class="tw-text-neutral-900 tw-mt-1 mbot15">
                        <?php echo(isset($lead) && $lead->nature_of_work_name != '' ? e($lead->nature_of_work_name) : '-') ?></dd>
          ...
          ?>
            ...
            <div class="col-md-3">
                <?php
                    $selected = '';
                    if (isset($lead)) {
                        $selected = isset($lead->nature_of_work_id) ? $lead->nature_of_work_id : '';

                    }

                    echo render_leads_nature_of_work_select(
                        $nature_of_work, 
                        $selected,
                        'nature_of_work',
                        'lead_nature_of_work'
