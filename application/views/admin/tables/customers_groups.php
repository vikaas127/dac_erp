...
$aColumns = ['name', 'default_discount', 'default_profit_margin', 'override_allowed', 'quantity_discount_allowed','special_discount_allowed','offer_discount_allowed','additional_discount_allowed'];
...
foreach ($rResult as $aRow) {
    ...
    $row[] = '<a href="#" data-toggle="modal" data-target="#customer_group_modal" 
                ...
                data-special_discount_allowed="' . $aRow['special_discount_allowed'] . '"
                data-offer_discount_allowed="' . $aRow['offer_discount_allowed'] . '"
    ...
    $row[] = $aRow['quantity_discount_allowed'] ? '<i class="fa fa-check text-success"></i>' : '<i class="fa fa-times text-danger"></i>';
     $row[] = $aRow['special_discount_allowed'] ? '<i class="fa fa-check text-success"></i>' : '<i class="fa fa-times text-danger"></i>';
      $row[] = $aRow['offer_discount_allowed'] ? '<i class="fa fa-check text-success"></i>' : '<i class="fa fa-times text-danger"></i>';
