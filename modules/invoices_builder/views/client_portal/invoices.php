         ...
         <thead>
            <tr>
                ...
                foreach($custom_fields as $field){ ?>
                    <th><?php echo ib_html_entity_decode($field['name']); ?></th>
                <?php } ?>
            </tr>
        </thead>
        <tbody>
            <?php foreach($invoices as $invoice){ ?>
                <tr>
                    <td data-order="<?php echo ib_html_entity_decode($invoice['number']); ?>"><a href="<?php echo site_url('invoices_builder/invoice_link/index/'.$invoice['id'].'/'.$invoice['hash']); ?>" class="invoice-number"><?php echo format_invoice_number($invoice['invoice_id']); ?></a></td>
                    <td data-order="<?php echo ib_html_entity_decode($invoice['date']); ?>"><?php echo _d($invoice['date']); ?></td>
                    <td data-order="<?php echo ib_html_entity_decode($invoice['duedate']); ?>"><?php echo _d($invoice['duedate']); ?></td>
                    <td data-order="<?php echo ib_html_entity_decode($invoice['total']); ?>"><?php echo app_format_money($invoice['total'], $invoice['currency_name']); ?></td>
