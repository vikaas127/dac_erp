									...
									<tr>
										<td>
											<div class="row">
												...
												<div class="col-md-3">
												<input type="number" onchange="purchase_calculate_total()" data-toggle="tooltip" value="<?php if(isset($goods_receipt)){ echo $goods_receipt->ShippingCharge; }else{ echo '0';} ?>" class="form-control pull-left text-right" name="ShippingCharge">
												</div>
											</div>
										</td>
										<td class="ShippingCharge"></td>
									</tr>
									<tr id="totalmoney">
