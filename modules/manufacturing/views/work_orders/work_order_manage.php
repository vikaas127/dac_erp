				...
				<div class="panel_s"> 
					<div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-md-4 leads-filter-column">
								<div class="form-group">
									<select name="work_order_filter[]" id="work_order_filter" data-live-search="true" class="selectpicker" multiple="true" data-actions-box="true" data-width="100%" data-none-selected-text="<?php echo _l('work_order'); ?>">
										<?php foreach ($operation_names as $operation_name) { ?>
											<option value="<?php echo new_html_entity_decode($operation_name); ?>"><?php echo new_html_entity_decode($operation_name); ?></option>
										<?php } ?>
									</select>
								</div>
							</div>
