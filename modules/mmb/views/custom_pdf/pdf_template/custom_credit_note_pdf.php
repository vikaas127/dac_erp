...
// The items table
$items = customPdfItemsTableData($credit_note, 'credit_note', 'pdf');
...
$total_bg_color = !empty(getPdfOptions('credit_note', 'items_table', 'total_row_bg_color')) ? getPdfOptions('credit_note', 'items_table', 'total_row_bg_color') : "#f0f0f0";
$total_text_color = !empty(getPdfOptions('credit_note', 'items_table', 'total_row_text_color')) ? getPdfOptions('credit_note', 'items_table', 'total_row_text_color') : "#000000";
