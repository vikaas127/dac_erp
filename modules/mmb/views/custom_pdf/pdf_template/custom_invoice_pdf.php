...
// The items table
$items = customPdfItemsTableData($invoice, 'invoice', 'pdf');
...
$total_bg_color = !empty(getPdfOptions('invoice', 'items_table', 'total_row_bg_color')) ? getPdfOptions('invoice', 'items_table', 'total_row_bg_color') : "#f0f0f0";
$total_text_color = !empty(getPdfOptions('invoice', 'items_table', 'total_row_text_color')) ? getPdfOptions('invoice', 'items_table', 'total_row_text_color') : "#000000";
