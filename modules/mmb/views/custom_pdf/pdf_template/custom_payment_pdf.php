...
$heading_row_bg_color = !empty(getPdfOptions('payment', 'items_table', 'heading_row_bg_color')) ? getPdfOptions('payment', 'items_table', 'heading_row_bg_color') : '#3A4656';
$heading_row_text_color = !empty(getPdfOptions('payment', 'items_table', 'heading_row_text_color')) ? getPdfOptions('payment', 'items_table', 'heading_row_text_color') : '#fff';

// Header
$tblhtml = '<table width="100%" bgcolor="#fff" cellspacing="0" cellpadding="5" border="0">
<tr height="30" style="color:' . $heading_row_text_color . ';" bgcolor="' . $heading_row_bg_color . '">
...
$row_bg_color = !empty(getPdfOptions('payment', 'items_table', 'row_bg_color')) ? getPdfOptions('payment', 'items_table', 'row_bg_color') : '#ffffff';
$row_text_color = !empty(getPdfOptions('payment', 'items_table', 'row_text_color')) ? getPdfOptions('payment', 'items_table', 'row_text_color') : '#000000';

$tblhtml .= '<tbody>';
$tblhtml .= '<tr style="color:' . $row_text_color . ';" bgcolor="' . $row_bg_color . '">';
