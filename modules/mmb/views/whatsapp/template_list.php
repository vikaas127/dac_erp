...
<script type="text/javascript">
  initDataTable('.table-template_list', admin_url + 'mmb/whatsapp_api/datatable', undefined, undefined, undefined, undefined);
  $(document).on('click', '.load_data', function(event) {
    event.preventDefault();
    $.ajax({
      url: admin_url + "mmb/whatsapp_api/get_business_information",
      type: 'GET',
      dataType: 'json',
