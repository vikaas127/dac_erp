$(window).on("load", function () {
  ...
  "1" == app.options.enable_google_picker &&
  ...
  "Notification" in window &&
    "1" == app.options.desktop_notifications &&
      ...
      $.each(e, function (e, t) {
        (i = " "),
          !0 === t.started_timers
            ...
            : !1 === t.started_timers &&
              "project" != t.rel_type &&
              (i += 'data-subtext="' + t.rel_name + '"'),
          a.append(
            '<option value="' + t.id + '"' + i + ">" + t.name + "</option>"
          );
      });
    var n,
      s = $(".input-group-addon-bill-tasks-help");
    s.find(".popover-invoker").popover("destroy"),
      s.empty(),
      (n = empty(t)
        ? app.lang.invoice_task_item_project_tasks_not_included
      ...
      delay(function () {
        (s.attr("info-shown-count") < 3 ||
          void 0 === s.attr("info-shown-count")) &&
          ...
          (s.attr(
            ...
            void 0 === s.attr("info-shown-count")
              ? 1
              : parseInt(s.attr("info-shown-count")) + 1
          ),
          s.find(".popover-invoker").click());
      }, 3500);
  }
...
function mainWrapperHeightFix() {
  ...
  setup_menu.css("min-height", $(document).outerHeight(!0) - 126 + "px"),
    ...
    t < e &&
      e < $(window).height() &&
      content_wrapper.css("min-height", $(window).height() - 63 + "px"),
    t > e &&
      t < $(window).height() &&
      content_wrapper.css("min-height", $(window).height() - 63 + "px"),
    is_mobile() &&
      "true" == isRTL &&
      side_bar.css("min-height", $(document).outerHeight(!0) - 63 + "px");
}
function set_body_small() {
  var e = null != navigator.userAgent.match(/iPad/i);
  $(this).width() < 769 || e || is_mobile()
...
function initDataTable(e, t, a, i, n, s) {
  ...
  (app.options.tables_pagination_limit = parseFloat(
    ...
    -1 == $.inArray(app.options.tables_pagination_limit, p) &&
      (p.push(app.options.tables_pagination_limit),
      ...
      initComplete: function (e, t) {
        ...
        s.length && s.attr("colspan", a.find("thead th").length),
          is_mobile() &&
            ...
            (a.DataTable().column(0).visible(!1, !1).columns.adjust(),
        ...
        o.text().trim() == app.lang.options && o.addClass("not-export"),
          l.find('input[type="checkbox"]').length > 0 &&
            l.addClass("not-export"),
        ...
        data: function (e) {
          for (var t in (Array.isArray(e.order) &&
            (e.order = e.order.map(function (e) {
              ...
              return (
                t.length > 0 &&
                  1 == t[0].dataset.customField &&
                  (e.type = t[0].dataset.type),
                e
              );
            })),
          "undefined" != typeof csrfData &&
            (e[csrfData.token_name] = csrfData.hash),
          n))
            e[t] = $(n[t]).val();
          o.attr("data-last-order-identifier") &&
            (e.last_order_identifier = o.attr("data-last-order-identifier"));
          var a = o[0].getAttribute("id");
          a &&
            Object.hasOwn(app.dtFilters, a) &&
            (e.filters = app.dtFilters[a]);
        },
      },
...
function update_todo_items() {
  ...
  $.each(e, function () {
    ...
    0 === e.length
      ...
      : e.length > 0 &&
        ($(".unfinished-todos li.no-todos").hasClass("hide") ||
    ...
    0 === t.length
      ...
      : t.length > 0 &&
        ($(".finished-todos li.no-todos").hasClass("hide") ||
...
function delete_todo_item(e, t) {
  requestGetJSON("todo/delete_todo_item/" + t).done(function (t) {
    (!0 !== t.success && "true" != t.success) ||
      ($(e).parents("li").remove(), update_todo_items());
  });
}
...
function init_roles_permissions(e, t) {
  if (
    ((e = void 0 === e ? $('select[name="role"]').val() : e),
    !(
      $('.member > input[name="isedit"]').length > 0 &&
      void 0 !== e &&
      void 0 === t
    ) &&
      !0 !== $('input[name="administrator"]').prop("checked") &&
      "" !== e)
  ) {
            ...
            t.data("name") == e &&
              $.each(a, function (a, i) {
                t.find('input[id="' + e + "_" + i + '"]').prop("checked", !0),
                  "view" == i
                    ? t.find("[data-can-view]").change()
                    : "view_own" == i && t.find("[data-can-view-own]").change();
              });
          });
        });
    });
...
function toggle_small_view(e, t) {
  ...
  if (0 !== a.length) {
    var i = !1;
    a.hasClass("col-md-5")
      ? (a.removeClass("col-md-5").addClass("col-md-12"),
        (i = !0),
        $(".toggle-small-view")
          .find("i")
          .removeClass("fa fa-angle-double-right")
          .addClass("fa fa-angle-double-left"))
      : (a.addClass("col-md-5").removeClass("col-md-12"),
        $(".toggle-small-view")
          .find("i")
...
function elFinderBrowser(e, t, a) {
  return (
    (tinymce.activeEditor.windowManager.elfinderCallback = e),
...
function init_editor(e, t) {
  ...
  if (0 !== a.length) {
    ...
    if (
      ("true" == isRTL &&
        ((i.directionality = "rtl"), i.plugins.push("directionality")),
      void 0 !== t)
    )
      for (var n in t)
  ...
  if (is_mobile()) {
    ...
    $.each(e, function () {
      ...
      void 0 === e && (e = $(this).attr("data-title")),
        void 0 !== e &&
          ($(this).append(" " + e), $(this).removeClass("btn-with-tooltip"));
    });
...
function init_form_reminder(e) {
  ...
  $.each(t, function (e, t) {
    $(t).appFormValidator({
      rules: { date: "required", staff: "required", description: "required" },
...
function new_task_reminder(e) {
  ...
  !t.is(":visible") || (t.is(":visible") && null != t.attr("data-edit"))
    ? (t.slideDown(400, function () {
      ...
      t
        .find("#staff")
        .selectpicker("val", t.find("#staff").attr("data-current-staff")),
      t.find("#notify_by_email").prop("checked", !1),
      null != t.attr("data-edit") && t.removeAttr("data-edit"),
      t.isInViewport() ||
        $("#task-modal").animate({ scrollTop: t.offset().top + "px" }, "fast"))
    : t.slideUp();
}
function edit_reminder(e, t) {
  requestGetJSON("misc/get_reminder/" + e).done(function (t) {
    ...
    0 === a.length && $("body").hasClass("all-reminders")
      ? ((a = $(".reminder-modal--"))
          .find('input[name="rel_type"]')
          .val(t.rel_type),
        a.find('input[name="rel_id"]').val(t.rel_id))
      : $("#task-modal").is(":visible") &&
        ((a = $("#newTaskReminderToggle")).attr("data-edit") &&
        a.attr("data-edit") == e
...
function reload_reminders_tables() {
  $.each(
    [".table-reminders", ".table-reminders-leads", ".table-my-reminders"],
    function (e, t) {
      $.fn.DataTable.isDataTable(t) &&
        $("body").find(t).DataTable().ajax.reload();
    }
  );
}
...
function edit_note(e) {
  var t = $("body")
    ...
    .val();
  "" !== t &&
    ($.post(admin_url + "misc/edit_note/" + e, { description: t }).done(
      function (t) {
      ...
      requestGet(buildUrl(admin_url + a, o))
        .done(function (a) {
          d++,
            ...
            $('[data-col-status-id="' + e + '"]').attr(
              "data-total",
              parseInt(
                $('[data-col-status-id="' + e + '"]').attr("data-total")
              ) + $("<ul></ul>").append(a).find("li").length
            ),
            $(t).attr("data-page", d),
...
function check_kanban_empty_col(e) {
  ...
  $.each(t, function (t, a) {
    0 == $(a).find(e).length
      ? ($(a).find(".kanban-empty").removeClass("hide"),
        $(a).find(".kanban-load-more").addClass("hide"))
      : $(a).find(".kanban-empty").addClass("hide");
  });
}
          ...
          fix_kanban_height(i, n),
            ...
            $(".status").sortable({
              ...
              sort: function (e, t) {
                ...
                var i = $(a).offset();
                i.top + a.offsetHeight - e.pageY < 20
                  ? (a.scrollTop = a.scrollTop + 60)
                  : e.pageY - i.top < 20 && (a.scrollTop = a.scrollTop - 60),
                  i.left + a.offsetWidth - e.pageX < 20
                    ? (a.scrollLeft = a.scrollLeft + 60)
                    : e.pageX - i.left < 20 &&
                      (a.scrollLeft = a.scrollLeft - 60);
              },
              change: function () {
            ...
            if (newsFeedDropzone.getQueuedFiles().length > 0)
              return (
                (newsFeedDropzone.options.url =
                  admin_url + "newsfeed/add_post_attachments/" + e.postid),
      ...
      appCreateDropzoneOptions({
        ...
        success: function (e, t) {
          0 === this.getUploadingFiles().length &&
            ...
            (newsfeed_new_post((t = JSON.parse(t)).postid),
...
function load_post_likes(e) {
  track_load_post_likes <= post_likes_total_pages &&
    ...
    track_load_post_likes >= post_likes_total_pages - 1 &&
...
function load_comment_likes(e) {
  track_load_comment_likes <= comment_likes_total_pages &&
    ...
    track_load_comment_likes >= comment_likes_total_pages - 1 &&
      $(".likes_modal .modal-footer").addClass("hide"));
}
function load_more_comments(e) {
  ...
  a <= i &&
    ($.post(admin_url + "newsfeed/init_post_comments/" + t, { page: a }).done(
      function (i) {
...
function like_comment(e, t) {
  requestGetJSON("newsfeed/like_comment/" + e + "/" + t).done(function (t) {
    (!0 !== t.success && "true" != t.success) ||
      $('[data-commentid="' + e + '"]').replaceWith(t.comment);
  });
}
...
function add_comment(e) {
  ...
  $.post(admin_url + "newsfeed/add_comment", {
    ...
    (!0 !== (a = JSON.parse(a)).success && "true" != a.success) ||
      ($(e).val(""),
      $("body").find('[data-comments-postid="' + t + '"] .post-comment')
        .length > 0
        ? $("body")
...
function remove_post_comment(e, t) {
  requestGetJSON("newsfeed/remove_post_comment/" + e + "/" + t).done(function (
    t
  ) {
    (!0 !== t.success && "true" != t.success) ||
      $('.comment[data-commentid="' + e + '"]').remove();
  });
}
function refresh_post_likes(e) {
  requestGet("newsfeed/init_post_likes/" + e + "?refresh_post_likes=true").done(
    function (t) {
...
function validate_lead_form() {
  ...
  $.each(leadUniqueValidationFields, function (a, i) {
    (e[i] = {}),
      ...
      void 0 !== app.lang[i + "_exists"] &&
        (t[i] = { remote: app.lang[i + "_exists"] });
  }),
    ...
    $.post(e.attr("action"), t)
      .done(function (e) {
        "" !== (e = JSON.parse(e)).message && alert_float("success", e.message),
          e.proposal_warning && 0 != e.proposal_warning
            ? ($("body").find("#lead_proposal_warning").removeClass("hide"),
              $("body").find("#lead-modal").animate({ scrollTop: 0 }, 800))
            : _lead_init_data(e, e.id),
          $.fn.DataTable.isDataTable(".table-leads")
            ? table_leads.DataTable().ajax.reload(null, !1)
            : $("body").hasClass("kan-ban-body") && leads_kanban();
      })
      .fail(function (e) {
...
function _lead_init_data(e, t) {
  ...
  if (
    ...
    [
      ...
      "#lead_activity",
      "#gdpr",
    ].indexOf(a) > -1 && (window.location.hash = a),
    ...
    "undefined" != typeof Dropbox &&
      ...
      "undefined" != typeof leadAttachmentsDropzone &&
    ...
    void 0 !== n
      ? i.find("#lead-latest-activity").html(n)
      : i.find(".lead-latest-activity > .lead-info-heading").addClass("hide"),
      $("[lead-is-junk-or-lost]").length > 0 &&
...
function print_expense_information() {
  var e = $("#tab_expense").clone(),
    t = $("#expenseHeadings"),
    a =
      t.find("#expenseCategory").text().trim() +
      "<h4>" +
      t.find("#expenseName").text().trim() +
      "</h4>";
...
function update_kan_ban_total_when_moving(e, t) {
  if (
    e.sender &&
    (a = $(e.sender.closest(".kan-ban-col"))).data("status-id") != t
  ) {
    var a,
      i = $('[data-col-status-id="' + t + '"]');
    i.attr("data-total", parseInt(i.attr("data-total")) + 1),
      (a = $(e.sender.closest(".kan-ban-col"))).attr(
        "data-total",
        parseInt(a.attr("data-total")) - 1
      );
  }
}
...
function delete_lead_attachment(e, t, a) {
  confirm_delete() &&
    requestGetJSON("leads/delete_attachment/" + t + "/" + a)
      .done(function (t) {
        (!0 !== t.success && "true" != t.success) ||
          ($(e).parents(".lead-attachment-wrapper").remove(),
          _lead_init_data(t, t.id));
      })
      .fail(function (e) {
        alert_float("danger", e.responseText);
...
function delete_lead_note(e, t, a) {
  confirm_delete() &&
    requestGetJSON("leads/delete_note/" + t + "/" + a)
      .done(function (t) {
        (!0 !== t.success && "true" != t.success) ||
          ($(e).parents(".lead-note").remove(), _lead_init_data(t, t.id));
      })
      .fail(function (e) {
        alert_float("danger", e.responseText);
      });
...
function add_proposal_comment() {
  ...
  if ("" != e) {
    ...
    (t.content = e),
      ...
      $("body").append('<div class="dt-loader"></div>'),
      $.post(admin_url + "proposals/add_proposal_comment", t).done(function (
        e
      ) {
        (e = JSON.parse(e)),
          $("body").find(".dt-loader").remove(),
          1 == e.success && ($("#comment").val(""), get_proposal_comments());
      });
  }
}
...
function edit_proposal_comment(e) {
  var t = $("body")
    ...
    .val();
  "" != t &&
    ($.post(admin_url + "proposals/edit_comment/" + e, { content: t }).done(
      function (a) {
...
function proposal_convert_template(e) {
  ...
  requestGet("proposals/get_" + t + "_convert_data/" + proposal_id).done(
    function (e) {
      $(".proposal-pipeline-modal").is(":visible") &&
        $(".proposal-pipeline-modal").modal("hide"),
        $("#convert_helper").html(e),
        $("#convert_to_" + t).modal({ show: !0, backdrop: "static" }),
        reorder_items();
    }
  );
}
...
function init_table_tickets(e) {
  ...
  if (0 !== $("body").find(".tickets-table").length) {
    ...
    var n = [0],
      s = admin_url + "tickets";
    if (
      ($("body").hasClass("tickets-page") && (s += "?bulk_actions=true"),
...
function do_task_checklist_items_height(e) {
  void 0 === e &&
    (e = $("body").find("textarea[name='checklist-description']")),
    $.each(e, function () {
      var e = $(this).val();
      $(this).outerHeight() <
        this.scrollHeight +
...
function recalculate_checklist_items_progress() {
  var e = $('input[name="checklist-box"]:checked').length,
    ...
    i = $(".task-progress-bar");
  if (
    ($(".task-total-checklist-completed").text(e),
    0 == t
    ...
    return (
      i.parents(".progress").addClass("hide"),
      e > 0
  ...
  i.parents(".progress").removeClass("hide"),
    ...
    e > 0
      ...
      : $(".chk-toggle-buttons").addClass("hide"),
    100 == a
      ? i.removeClass("progress-bar-default").addClass("progress-bar-success")
      : i.removeClass("progress-bar-success").addClass("progress-bar-default");
}
function remove_checklist_item_template(e) {
  requestGetJSON("tasks/remove_checklist_item_template/" + e).done(function (
    t
  ) {
    if (!0 === t.success || "true" == t.success) {
      ...
      $.each(n, function (e, t) {
        var a = $(t);
        a.find('textarea[name="checklist-description"]').val().trim() == i &&
          a.find(".save-checklist-template").removeClass("hide");
      }),
        a.find('option[value="' + e + '"]').remove(),
        a.selectpicker("refresh"),
        1 === a.find("option").length &&
          (a.selectpicker("destroy"),
...
function save_checklist_item_template(e, t) {
  ...
  $.post(admin_url + "tasks/save_checklist_item_template", {
    ...
    i
      ...
      .after('<option value="' + e.id + '">' + a.trim() + "</option>"),
      i.removeClass("hide"),
  ...
  return (
    setTimeout(function () {
      ...
      $.post(admin_url + "tasks/update_checklist_item", {
        ...
        t.resolve(),
          !0 === (n = JSON.parse(n)).can_be_template &&
            e
              .parents(".checklist")
...
function delete_checklist_item(e, t) {
  requestGetJSON("tasks/delete_checklist_item/" + e).done(function (e) {
    (!0 !== e.success && "true" != e.success) ||
      ($(t).parents(".checklist").remove(),
      recalculate_checklist_items_progress());
  });
}
function init_tasks_checklist_items(e, t) {
  $.post(admin_url + "tasks/init_checklist_items", { taskid: t }).done(
    function (t) {
...
function _task_attachments_more_and_less_checks() {
  ...
  0 === t.length
    ...
    : 0 !==
        $(".task_attachments_wrapper .task-attachment-col:visible").length ||
      a.hasClass("hide") ||
      a.click(),
    $.each($("#task-modal .comment-content"), function () {
      0 === $(this).find(".task-attachment-col").length &&
...
function remove_task_attachment(e, t) {
  confirm_delete() &&
    requestGetJSON("tasks/remove_task_attachment/" + t).done(function (e) {
      (!0 !== e.success && "true" != e.success) ||
        $('[data-task-attachment-id="' + t + '"]').remove(),
...
function add_task_comment(e) {
  ...
  taskCommentAttachmentDropzone.files.length > 0
    ...
    : (tinymce.activeEditor
        ...
        : ((t.content = $("#task_comment").val()), (t.no_editor = !0)),
      (t.taskid = e),
...
function remove_assignee(e, t) {
  confirm_delete() &&
    requestGetJSON("tasks/remove_assignee/" + e + "/" + t).done(function (e) {
      (!0 !== e.success && "true" != e.success) ||
        (alert_float("success", e.message), _task_append_html(e.taskHtml));
    });
}
    ...
    requestGetJSON(a).done(function (a) {
      $("body").find(".dt-loader").remove(),
        (!0 !== a.success && "true" != a.success) ||
          ...
          5 == e &&
            "function" == typeof _maybe_remove_task_from_project_milestone &&
            _maybe_remove_task_from_project_milestone(t),
...
function task_change_priority(e, t) {
  ...
  (url += "?single_task=" + a),
    requestGetJSON(url).done(function (e) {
      (!0 !== e.success && "true" != e.success) ||
        (reload_tasks_tables(), a && _task_append_html(e.taskHtml));
    });
}
...
function delete_user_unfinished_timesheet(e) {
  confirm_delete() &&
    requestGetJSON("tasks/delete_user_unfinished_timesheet/" + e).done(
      function (e) {
...
function make_task_public(e) {
  requestGetJSON("tasks/make_public/" + e).done(function (e) {
    (!0 !== e.success && "true" != e.success) ||
      (reload_tasks_tables(), _task_append_html(e.taskHtml));
  });
}
function new_task(e, t) {
  ...
  a.is(":visible") &&
    (-1 ===
      (e +=
        "&opened_from_lead_id=" + a.find('input[name="leadid"]').val()).indexOf(
        "?"
      ) && (e = e.replace("&", "?")),
    a.modal("hide"));
  var i = $("#task-modal");
    ...
    requestGet(e)
      .done(function (e) {
        $("#_task").html(e),
          ...
          $("#timer-select-task").is(":visible") &&
            ($(".system-popup-close").click(), (window._timer_id = t));
      })
      .fail(function (e) {
        alert_float("danger", e.responseText);
      });
...
function new_task_from_relation(e, t, a) {
  void 0 === t &&
    void 0 === a &&
    ((a = $(e).data("new-rel-id")), (t = $(e).data("new-rel-type"))),
...
function edit_task(e) {
  requestGet("tasks/task/" + e).done(function (e) {
    $("#_task").html(e),
      ...
      $("body").find("#_task_modal").modal({ show: !0, backdrop: "static" });
  });
}
    ...
    $.ajax({
      ...
      .done(function (e) {
        if (
          ...
          return (
            requestGet(admin_url + "/tasks/get_task_by_id/" + e.id).done(
              function (e) {
...
function system_popup(e) {
  ...
  var t = $("<div/>", { id: "system-popup", class: "system-popup" }).appendTo(
      "body"
    ),
    a = "";
  return (
  ...
  if ("" !== t || !n.is(":visible")) {
    if ("" !== a && "0" == t) {
      ...
      return (
        ...
        (s.content += "</select>"),
        "1" == app.options.has_permission_create_task &&
          ((s.content += '<div class="input-group-addon" style="opacity: 1;">'),
          (s.content +=
...
function init_task_modal(e, t) {
  var a = "",
    ...
    n = $("#_task_modal");
  i.is(":visible")
    ? ((a += "?opened_from_lead_id=" + i.find('input[name="leadid"]').val()),
      i.modal("hide"))
    : null != n.attr("data-lead-id") &&
      (a += "?opened_from_lead_id=" + n.attr("data-lead-id")),
...
function task_tracking_stats(e) {
  requestGet("tasks/task_tracking_stats/" + e).done(function (e) {
    $("<div/>", { id: "tracking-stats" }).appendTo("body").html(e),
...
function _init_timers_top_html(e) {
  ...
  e.total_timers > 0
    ? t.removeClass("hide").html(e.total_timers)
    : t.addClass("hide"),
    e.total_timers > 0
...
function save_edited_comment(e, t) {
  ...
  (a.id = e),
    ...
    $.post(admin_url + "tasks/edit_comment", a).done(function (t) {
      !0 === (t = JSON.parse(t)).success || "true" == t.success
        ? (alert_float("success", t.message), _task_append_html(t.taskHtml))
        : cancel_edit_comment(e),
        tinymce.remove('[data-edit-comment="' + e + '"] textarea');
    });
}
function fix_task_modal_left_col_height() {
  is_mobile() ||
    $("body")
      ...
      .css(
        "min-height",
        $("body").find(".task-single-col-right").outerHeight(!0) + "px"
      );
}
        ...
        tinymce.init({
          ...
          setup: function (e) {
            e.on("blur", function (a) {
              e.isDirty() &&
                $.post(admin_url + "tasks/update_task_description/" + t, {
...
function load_small_table_item(e, t, a, i, n) {
  ...
  "" === s || window.location.hash
    ? window.location.hash && !e && (e = window.location.hash.substring(1))
    : ((e = s), $('input[name="' + a + '"]').val("")),
    void 0 !== e &&
      "" !== e &&
...
function clear_billing_and_shipping_details() {
  for (var e in billingAndShippingFields)
    billingAndShippingFields[e].indexOf("country") > -1
      ? $('select[name="' + billingAndShippingFields[e] + '"]').selectpicker(
          "val",
          ""
        )
      : ($('input[name="' + billingAndShippingFields[e] + '"]').val(""),
        $('textarea[name="' + billingAndShippingFields[e] + '"]').val("")),
      "billing_country" == billingAndShippingFields[e] &&
        ($('input[name="include_shipping"]').prop("checked", !1),
  ...
  for (var a in billingAndShippingFields)
    (e = ""),
      billingAndShippingFields[a].indexOf("country") > -1
        ? (e = $("#" + billingAndShippingFields[a] + " option:selected").data(
            "subtext"
          ))
        : billingAndShippingFields[a].indexOf("shipping_street") > -1 ||
          billingAndShippingFields[a].indexOf("billing_street") > -1
...
function record_payment(e) {
  void 0 !== e &&
    "" !== e &&
    $("#invoice").load(admin_url + "invoices/record_invoice_payment_ajax/" + e);
}
...
function add_item_to_preview(e, t = null) {
  requestGetJSON("invoice_items/get_item_by_id/" + e + (t ? "/" + t : "")).done(
    function (e) {
      clear_item_preview_values(),
        ...
        $('.main textarea[name="long_description"]').val(
          e.long_description.replace(/(<|&lt;)br\s*\/*(>|&gt;)/g, " ")
        ),
        _set_item_preview_custom_fields_array(e.custom_fields),
        $('.main input[name="item_id"]').val(e.itemid);
      var t = [];
      ...
      var a = $('.main input[name="item_discount_percent"]');
      e.item_discount && "" != e.item_discount.trim()
        ? (a.attr("data-default-discount", "1"),
          a.attr("data-original-discount", e.item_discount))
        : (a.attr("data-default-discount", "0"),
          a.attr("data-original-discount", 0)),
        $('.main input[name="item_discount_percent"]').val(e.item_discount),
        $("#customer_group_id").val()
          ? $('.main input[name="item_discount_percent"]').val(e.item_discount)
          : $('.main input[name="item_discount_percent"]').val("");
      var i = $("body").find('.accounting-template select[name="currency"]'),
        n = i.attr("data-base"),
        s = i.find("option:selected").val(),
        o = $('.main input[name="rate"]');
      if (n == s) o.val(e.rate);
      else {
        var l = e["rate_currency_" + s];
        l && 0 !== parseFloat(l) ? o.val(l) : o.val(e.rate);
      }
      $(document).trigger({
...
function clear_item_preview_values(e) {
  ...
  a.find("textarea").val(""),
    ...
    a.find('input[name="item_discount_percent"]').val(""),
    a.find('input[name="unit"]').val(""),
...
function add_item_to_table(e, t, a, i) {
  if (
    "" !==
      (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e)
        .description ||
    "" !== e.long_description ||
    "" !== e.rate
  ) {
    console.log("Item object (e):", e);
    var n = "",
      s = lastAddedItemKey
        ? (lastAddedItemKey += 1)
    ...
    return (
      get_taxes_dropdown_template(l, e.taxname).done(function (a) {
        ...
        l.length > 0 &&
          $.each(l, function () {
            ...
            if (a.is(":checkbox")) {
              ...
              a.is("input")
                ? e.find("[data-fieldid]").attr("value", a.val())
                : e.find("[data-fieldid]").html(a.val()),
                e.find("[data-fieldid]").attr("name", i),
                "1" ==
                  e.find("[data-fieldid]").attr("data-custom-field-required") &&
                  (r = !0),
                (t = e.html());
            else if (a.is("select")) {
              "1" == $(this).attr("data-custom-field-required") && (r = !0);
              ...
              p.append(_),
                $.each(d, function (e, t) {
                  p.find('select option[value="' + t + '"]').attr(
                    "selected",
                    !0
                  );
                }),
          ...
          (n +=
            '<td class="discount"><input type="number" min="0" max="100" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
            s +
            '][item_discount_percent]" value="' +
            e.item_discount_percent +
            '" class="form-control" placeholder="Discount" ' +
            (e.item_discount_percent && "" != e.item_discount_percent.trim()
              ? 'data-default-discount="1" data-original-discount="' +
                e.item_discount_percent +
                '"'
              : 'data-default-discount="0" data-original-discount="0"') +
            ' readonly>'+

            '<input type="number" min="0" max="100" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
            s +
            '][item_basic_discount_percent]" value="' +
            e.item_basic_discount_percent +
            '" class="form-control" placeholder="Basic Discount" readonly>'+
            '<input type="number" min="0" max="100" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
            s +
            '][item_quantity_discount_percent]" value="' +
            e.item_quantity_discount_percent +
            '" class="form-control" placeholder="Quantity Discount" readonly>'+
            '<input type="number" min="0" max="100" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
            s +
            '][item_offer_discount_percent]" value="' +
            e.item_offer_discount_percent +
            '" class="form-control" placeholder="Offer Discount" readonly>'+
            '<input type="number" min="0" max="100" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
            s +
            '][item_special_discount_percent]" value="' +
            e.item_special_discount_percent +
            '" class="form-control" placeholder="Special Discount" readonly>'

            +'</td>');


            
        var c = parseFloat(e.item_discount_percent) || 0,
          p = c > 0 ? (o / c).toFixed(2) : 0;
        (n +=
          '<td class="item_price"><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" name="newitems[' +
          s +
          '][item_price]" value="' +
          p +
          '" class="form-control" placeholder="Item Price" readonly></td>'),
          (n +=
            '<td class="amount" align="right">' +
            format_money(o - (o * c) / 100, !0) +
            "</td>"),
          (n +=
        ...
        var _ = $('input[name="task_id"]').val(),
          m = $('input[name="expense_id"]').val();
        return (
          "" !== _ &&
            void 0 !== _ &&
            ((billed_tasks = _.split(",")),
            $.each(billed_tasks, function (e, t) {
              $("#billed-tasks").append(
                hidden_input("billed_tasks[" + s + "][]", t)
              );
            })),
          "" !== m &&
            void 0 !== m &&
            ((billed_expenses = m.split(",")),
            $.each(billed_expenses, function (e, t) {
              $("#billed-expenses").append(
                hidden_input("billed_expenses[" + s + "][]", t)
              );
            })),
...
function get_taxes_dropdown_template(e, t) {
  return (
    ...
    $.post(admin_url + "misc/get_taxes_dropdown_template", {
      name: e,
      taxname: t,
    })
  );
...
function init_ajax_project_search_by_customer_id(e) {
  init_ajax_search(
    "project",
    (e = void 0 === e ? "#project_id.ajax-search" : e),
    {
...
function get_item_preview_values() {
  ...
  return (
    ...
    (e.item_discount_percent = $(
      '.main input[name="item_discount_percent"]'
    ).val()),
    (e.item_basic_discount_percent = $(
      '.main input[name="item_basic_discount_percent"]'
    ).val()),
    (e.item_special_discount_percent = $(
      '.main input[name="item_special_discount_percent"]'
    ).val()),
    (e.item_quantity_discount_percent = $(
      '.main input[name="item_quantity_discount_percent"]'
    ).val()),
    (e.item_offer_discount_percent = $(
      '.main input[name="item_offer_discount_percent"]'
    ).val()),
    (e.unit = $('.main input[name="unit"]').val()),
    (e.item_id = $('.main input[name="item_id"]').val()),
    e
  );
}
...
//     o = 0,
//     l = 0,
//     d = parseFloat($('input[name="discount_percent"]').val()) || 0,
//     r = parseFloat($('input[name="discount_total"]').val()) || 0,
//     c = $(".discount-total-type.selected"),
//     p = $('select[name="discount_type"]').val(),
//     _ = parseFloat($("#basic_discount_percent").val()) || 0,
//     m = "1" == $("#quantity_discount_allowed").val(),
//     u = parseFloat($("#special_discount_percent").val()) || 0,
//     f = parseFloat($("#offer_discount_percent").val()) || 0,
//     h = parseFloat($('input[name="adjustment"]').val()) || 0;
//   $(".tax-area").remove(),
//     e.each(function () {
//       var e = $(this),
//         s = parseFloat(e.find("[data-quantity]").val()) || 1,
//         o = (parseFloat(e.find("td.rate input").val()) || 0) * s;
//       t += o;
//       var m = e.find('input[name$="[item_discount_percent]"]'),
//         h = "1" != m.data("default-discount"),
//         v = parseFloat(m.data("original-discount")) || 0,
//         b = h ? o * (1 - _ / 100) : o;
//       h || (b *= 1 - v / 100);
//       var g = b;
//       if ("before_tax" == p)
//         if (c.hasClass("discount-type-percent"))
//           (l += C = b * (d / 100)), (g = b - C);
//         else if (c.hasClass("discount-type-fixed")) {
//           (l += C = r * (o / (t || 1))), (g = b - C);
//         }
//       var k = (g * u) / 100;
//       i += k;
...
//           (l += C = r * (o / t)), (x -= C);
//         }
//       e.find("td.amount").html(format_money(x, !0));
//       var S = 100 * (1 - x / o);
//       m.val(accounting.toFixed(S, app.options.decimal_places)), (a += x);
//       var T = s > 0 ? x / s : 0;
//       e.find('input[name$="[item_price]"]').val(
//         accounting.toFixed(T, app.options.decimal_places)
//       );

//       e.find('input[name$="[item_basic_discount_percent]"]').val(_);
//       e.find('input[name$="[item_special_discount_percent]"]').val(u);
//       e.find('input[name$="[item_offer_discount_percent]"]').val(f);

//       e.find('input[name$="[item_quantity_discount_percent]"]').val(0);
//     }),
//     m &&
//       ((s = 0),
//       (o = a > 4e5 ? 4 : a > 3e5 ? 3 : a > 2e5 ? 2 : 0) > 0 &&
//         ($(".table.has-calculations tbody tr.item").each(function () {
//           var e = $(this),
//             t = parseFloat(e.find("[data-quantity]").val()) || 1,
//             a = (parseFloat(e.find("td.rate input").val()) || 0) * t,
//             i =
//               parseFloat(
//                 e
//                   .find("td.amount")
...
//           s += n;
//           var l = i - n;
//           e.find("td.amount").html(format_money(l, !0));
//           var d = t > 0 ? l / t : 0;
//           e.find('input[name$="[item_price]"]').val(
//             accounting.toFixed(d, app.options.decimal_places)
//           );
//           var r = 100 * (1 - l / a);
//           e.find('input[name$="[item_discount_percent]"]').val(
//             accounting.toFixed(r, app.options.decimal_places)
//           );
//         }),
//         (a = 0),
//         $(".table.has-calculations tbody tr.item").each(function () {
...
//           $(this).find('input[name$="[item_quantity_discount_percent]"]').val(o);
//         })));
//   var v = a + h;
//   $(".subtotal").html(
//     format_money(t, !0) +
...
//     $(".total").html(
//       format_money(v, !0) +
//         hidden_input("total", accounting.toFixed(v, app.options.decimal_places))
//     ),
//     $("#special_discount_area .discount-total").html("-" + format_money(i, !0)),
//     $("#offer_discount_area .discount-total").html("-" + format_money(n, !0)),
//     $(".adjustment").html(format_money(h)),
//     $('input[name="discount_total"]').val(
//       accounting.toFixed(r || (d / 100) * t, app.options.decimal_places)
//     ),
//     $("#discount_area .discount-total").html("-" + format_money(l, !0)),
//     $('input[name="special_discount_total"]').val(
//       accounting.toFixed(i, app.options.decimal_places)
//     ),
//     $('input[name="offer_discount_total"]').val(
//       accounting.toFixed(n, app.options.decimal_places)
//     ),
//     $('input[name="basic_discount_total"]').val(
//       accounting.toFixed((t * _) / 100, app.options.decimal_places)
//     ),
//     $('input[name="quantity_discount_total"]').val(
//       accounting.toFixed(s, app.options.decimal_places)
//     ),
//     $('input[name="quantity_discount_percent"]').val(o),
...
function calculate_total() {
  ...
  var e = $(".table.has-calculations tbody tr.item"),
    t = 0, // subtotal before discount
    a = 0, // total after discount
    i = 0, // special discount total
    n = 0, // offer discount total
    s = 0, // quantity discount total
    qtyDiscPercent = 0,
    l = 0, // main discount total (before/after tax)
    d = parseFloat($('input[name="discount_percent"]').val()) || 0,
    r = parseFloat($('input[name="discount_total"]').val()) || 0,
    c = $(".discount-total-type.selected"),
    p = $('select[name="discount_type"]').val(),
    basic = parseFloat($("#basic_discount_percent").val()) || 0,
    allowQtyDisc = "1" == $("#quantity_discount_allowed").val(),
    special = parseFloat($("#special_discount_percent").val()) || 0,
    offer = parseFloat($("#offer_discount_percent").val()) || 0,
  ...
  e.each(function () {
    var row = $(this),
      qty = parseFloat(row.find("[data-quantity]").val()) || 1,
      originalAmount = (parseFloat(row.find("td.rate input").val()) || 0) * qty;

    t += originalAmount;

    /** ============================
     *  READ STORED DISCOUNT VALUES
     *  ============================ */
    let saved_basic = parseFloat(row.find('input[name$="[item_basic_discount_percent]"]').val()) || 0;
    let saved_special = parseFloat(row.find('input[name$="[item_special_discount_percent]"]').val()) || 0;
    let saved_offer = parseFloat(row.find('input[name$="[item_offer_discount_percent]"]').val()) || 0;
    let saved_qty = parseFloat(row.find('input[name$="[item_quantity_discount_percent]"]').val()) || 0;

    /** ============================
     *  CHECK IF DISCOUNT MUST APPLY
     *  ============================ */
    let apply_basic = (basic !== saved_basic);
    let apply_special = (special !== saved_special);
    let apply_offer = (offer !== saved_offer);

    /** ============================
     *  BASIC DISCOUNT
     *  ============================ */
    let calc_basic = originalAmount;

    if (apply_basic) {
      calc_basic = calc_basic * (1 - basic / 100);
    } else {
      calc_basic = calc_basic * (1 - saved_basic / 100);
    }

    /** ============================
     *  BEFORE TAX MAIN DISCOUNT
     *  ============================ */
    let g = calc_basic;
    let C = 0;
    ...
    if (apply_special) {
      calc_special = g * (special / 100);
    } else {
      calc_special = g * (saved_special / 100);
    }

    i += calc_special;
    let after_special = g - calc_special;
    ...
    if (apply_offer) {
      calc_offer = after_special * (offer / 100);
    } else {
      calc_offer = after_special * (saved_offer / 100);
    }

    n += calc_offer;
    let after_offer = after_special - calc_offer;

    /** ============================
     *  AFTER TAX MAIN DISCOUNT
     *  ============================ */
    if (p == "after_tax") {
      if (c.hasClass("discount-type-percent")) {
        C = after_offer * (d / 100);
    ...
    /** ============================
     *  UPDATE ITEM AMOUNT & PRICE
     *  ============================ */
    var finalAmount = after_offer;
    row.find("td.amount").html(format_money(finalAmount, !0));

    let itemDiscountPercent = 100 * (1 - finalAmount / originalAmount);
    row.find('input[name$="[item_discount_percent]"]').val(
      accounting.toFixed(itemDiscountPercent, app.options.decimal_places)
    );

    let itemPrice = qty > 0 ? finalAmount / qty : 0;
    row.find('input[name$="[item_price]"]').val(
      accounting.toFixed(itemPrice, app.options.decimal_places)
    );

    /** ============================
     *  STORE UPDATED DISCOUNT VALUES
     *  ============================ */
    row.find('input[name$="[item_basic_discount_percent]"]').val(basic);
    row.find('input[name$="[item_special_discount_percent]"]').val(special);
    row.find('input[name$="[item_offer_discount_percent]"]').val(offer);
    row.find('input[name$="[item_quantity_discount_percent]"]').val(saved_qty); // update later

    a += finalAmount;
  });

  /**********************************************************
   * QUANTITY DISCOUNT SLAB (APPLY ONLY IF ALLOWED)
   **********************************************************/
  if (allowQtyDisc) {
    qtyDiscPercent =
      a > 400000 ? 4 :
    ...
    if (qtyDiscPercent > 0) {
      ...
      $(".table.has-calculations tbody tr.item").each(function () {
        let row = $(this),
          qty = parseFloat(row.find("[data-quantity]").val()) || 1,
          rateAmt = (parseFloat(row.find("td.rate input").val()) || 0) * qty,
          finalAmt =
            parseFloat(
              row.find("td.amount").text().replace(/[^0-9.-]+/g, "")
            ) || 0;

        let qtyDisc = (finalAmt * qtyDiscPercent) / 100;
        s += qtyDisc;

        let newAmt = finalAmt - qtyDisc;

        row.find("td.amount").html(format_money(newAmt, !0));

        let newPrice = qty > 0 ? newAmt / qty : 0;
        row.find('input[name$="[item_price]"]').val(
          accounting.toFixed(newPrice, app.options.decimal_places)
        );

        let newDiscPercent = 100 * (1 - newAmt / rateAmt);
        row.find('input[name$="[item_discount_percent]"]').val(
          accounting.toFixed(newDiscPercent, app.options.decimal_places)
        );

        row.find('input[name$="[item_quantity_discount_percent]"]').val(qtyDiscPercent);
      });
   ...
   * FINAL TOTALS
   **********************************************************/
  var total = a + adjustment;

  $(".subtotal").html(
    format_money(t, !0) +
      hidden_input("subtotal", accounting.toFixed(t, app.options.decimal_places))
  );

  $(".total").html(
    format_money(total, !0) +
      hidden_input("total", accounting.toFixed(total, app.options.decimal_places))
  );
  ...
  $('input[name="special_discount_total"]').val(accounting.toFixed(i, app.options.decimal_places));
  $('input[name="offer_discount_total"]').val(accounting.toFixed(n, app.options.decimal_places));
  $('input[name="basic_discount_total"]').val(accounting.toFixed((t * basic) / 100, app.options.decimal_places));
  $('input[name="quantity_discount_total"]').val(accounting.toFixed(s, app.options.decimal_places));
  $('input[name="quantity_discount_percent"]').val(qtyDiscPercent);
...
function format_money(e, t) {
  return void 0 !== t && t
    ? accounting.formatMoney(e, { symbol: "" })
...
function init_currency(e, t) {
  ...
  (a.length || e) &&
    requestGetJSON(
      "misc/get_currency/" + (e || a.find('select[name="currency"]').val())
    ).done(function (e) {
    ...
    if (
      ...
      if (t.length > 0 && a.hasClass("initialized"))
        ...
        void 0 !== o ? (s.project_id = o) : void 0 !== l && (s.customer_id = l),
          $.post(admin_url + "invoices/get_invoices_total", s).done(function (
            e
          ) {
    ...
    requestGetJSON("misc/delete_note/" + t).done(function (t) {
      if (!0 === t.success || "true" == t.success) {
        ...
        a.attr("data-total", i),
          i <= 0
            ? n.addClass("hide")
            : n.html('<span class="badge">' + i + "</span>");
      }
    });
}
  ...
  (t.prefix = $("body").find('input[name="s_prefix"]').val()),
    $.post($(e).data("url"), t).done(function (e) {
      (e = JSON.parse(e)).success &&
        e.message &&
        (alert_float("success", e.message), $("#prefix").html(t.prefix));
    });
}
    ...
    $.each(t, function (e, a) {
      if (4 == a.length) {
        ...
        if (i.hasClass("format-n-yy")) a = a.substr(-2);
          ...
          var n;
          "d-m-Y" == app.options.date_format ||
          "d/m/Y" == app.options.date_format ||
          "Y-m-d" == app.options.date_format ||
          "d.m.Y" == app.options.date_format
            ? (n = 1)
            : ("m-d-Y" != app.options.date_format &&
                "m.d.Y" != app.options.date_format &&
                "m/d/Y" != app.options.date_format) ||
              (n = 0),
...
function init_tabs_scrollable() {
  "true" != isRTL
    ? ($(window).width() <= 768 && $("body").find(".toggle_view").remove(),
      $(".horizontal-scrollable-tabs").horizontalTabs())
    : ($(".arrow-left, .arrow-right").css("display", "none"),
      $(".horizontal-scrollable-tabs").removeClass(
...
function set_notification_read_inline(e) {
  requestGet("misc/set_notification_read_inline/" + e).done(function () {
    var t = $("body").find(
      '.notification-wrapper[data-notification-id="' + e + '"]'
    );
...
function validate_calendar_form() {
  appValidateForm(
    ...
    { title: "required", start: "required", reminder_before: "required" },
...
function fetch_notifications(e) {
  requestGetJSON("misc/notifications_check").done(function (e) {
    ...
    document.title =
      a > 0 ? "(" + a + ") " + doc_initial_title : doc_initial_title;
      ...
      i.length > 0 &&
        $.each(i, function (e, a) {
          ...
          $.notify("", {
            ...
            tag: a,
            closeTime:
              "0" != app.options.dismiss_desktop_not_after
                ? 1e3 * app.options.dismiss_desktop_not_after
                : null,
          })
            .close(function () {
              requestGet("misc/set_desktop_notification_read/" + a).done(
                function (e) {
                  var i = t.find(".icon-total-indicator");
                  t.find(
                    'li[data-notification-id="' + a + '"] .notification-box'
                  ).removeClass("unread");
                  var n = i.text();
                  (n = n.trim()),
                    (n -= 1) > 0
                      ? ((document.title = "(" + n + ") " + doc_initial_title),
                        i.html(n))
...
function init_new_task_comment(e) {
  tinymce.get("task_comment") && tinymce.remove("#task_comment"),
    "undefined" != typeof taskCommentAttachmentDropzone &&
      ...
      appCreateDropzoneOptions({
        ...
        sending: function (e, t, a) {
          a.append(
            ...
            tinyMCE.activeEditor
              ? a.append("content", tinyMCE.activeEditor.getContent())
              : a.append("content", $("#task_comment").val());
        },
        success: function (e, t) {
          (t = JSON.parse(t)),
            0 === this.getUploadingFiles().length &&
              0 === this.getQueuedFiles().length &&
              (_task_append_html(t.taskHtml), tinymce.remove("#task_comment"));
        },
      })
    ));
  ...
  (t.content_style =
    "span.mention {        background-color: #eeeeee;        padding: 3px;    }"),
    (t.setup = function (e) {
...
function merge_field_format_url(e, t, a, i) {
  return (
    e &&
      e.indexOf("%7B") > -1 &&
      e.indexOf("%7D") > -1 &&
      (e = e.replaceAll("%7B", "{").replaceAll("%7D", "}")),
    e
  );
}
...
function salesExtenalFileUpload(e, t) {
  ...
  (a.rel_id = $("body").find('input[name="_attachment_sale_id"]').val()),
    ...
    (a.files = e),
    (a.external = t),
    $.post(admin_url + "misc/add_sales_external_attachment", a).done(
      function () {
        "estimate" == a.type
          ? $("body").hasClass("estimates-pipeline")
          ...
          : "function" == typeof window["init_" + a.type] &&
            window["init_" + a.type](a.rel_id),
...
function add_template(e, t) {
  $("#modal-wrapper").load(
    ...
    { slug: "new", rel_type: e, rel_id: t },
    function () {
      $("#TemplateModal").is(":hidden") &&
        $("#TemplateModal").modal({ backdrop: "static", show: !0 }),
...
function edit_template(e, t, a) {
  $("#modal-wrapper").load(
    admin_url + "templates/modal",
    { slug: "edit", id: t, rel_type: e, rel_id: a },
    function () {
      $("#TemplateModal").is(":hidden") &&
        $("#TemplateModal").modal({ backdrop: "static", show: !0 }),
        appValidateForm($("#template-form"), { name: "required" }),
...
function delete_template(e, t, a) {
  confirm_delete() &&
    $.post(admin_url + "templates/delete/" + a).done(function (a) {
      (!0 !== (a = JSON.parse(a)).success && "true" != a.success) ||
        ("proposals" === t
          ? $(e).parents(".proposal-templates-wrapper").html("")
          : "contracts" === t &&
            $(e).parents(".contract-templates-wrapper").html(""),
        get_templates(t));
    });
}
  ...
  requestGetJSON(admin_url + "templates/index/" + a).done(function (e) {
    ...
    tinymce.activeEditor.execCommand("mceInsertContent", !1, a.content),
      "proposals" == t
        ...
        : "contracts" == t && $('a[aria-controls="tab_content"]').click(),
...
function add_batch_payment() {
  $("#modal-wrapper").load(
    ...
    function () {
      $("#batch-payment-modal").is(":hidden") &&
        $("#batch-payment-modal").modal({ backdrop: "static", show: !0 }),
        init_selectpicker(),
        init_datepicker();
...
$("body").on("loaded.bs.select change", "select.ajax-search", function (e) {
  ...
  $(document).on("mousemove", function (e) {
    !is_mobile() &&
      ...
      (("true" == isRTL && $(window).width() - e.pageX <= 10) ||
        ("false" == isRTL && e.pageX <= 10)) &&
      $(".hide-menu").click();
  }),
  $(function () {
    var e, t;
    totalUnreadNotifications > 0 &&
      (document.title =
        "(" + totalUnreadNotifications + ") " + doc_initial_title),
        ...
        .on("submit.app.entity", function (e) {
          $(this).validate().checkForm() &&
            $.each($('[data-entities-encode="true"]'), function () {
              $(this).hasClass("_entities-processed") ||
      ...
      add_hotkey("Shift+E", function () {
        ...
        e.is(":visible") || t.is(":visible")
          ? e.is(":visible")
            ...
            : t.is(":visible") &&
              edit_task(
                t.find("[data-task-single-id]").attr("data-task-single-id")
              )
      ...
      add_hotkey("Shift+F", function () {
        ...
        if (e.is(":visible")) {
          ...
          5 != t.attr("data-status") &&
            mark_complete(t.attr("data-task-single-id"));
        }
      }),
          ...
          $(t).on(
            ...
            function (e) {
              if (
                ...
                !$(this).is(":disabled") &&
                void 0 !== $(this).rules() &&
                1 === Object.keys($(this).rules()).length &&
    ...
    if (
      (i.length &&
        (i.parents("li").not(".quick-links").addClass("active"),
    ...
    side_bar.metisMenu(),
      ...
      $("#search_input").on("click focus", function () {
        if ("" == $(this).val()) {
          ...
          e.find("li").length > 0 &&
            (e.css("width", $(this).outerWidth() + "px"),
      ...
      $("#search_input").on(
        "keyup paste" + ("safari" == app.browser ? " input" : ""),
        function () {
          var e = $("#search-history");
          ...
          (t.length < 2 &&
            -1 === app.user_language.indexOf("chinese") &&
            -1 === app.user_language.indexOf("japanese")) ||
    ...
    if (
      ...
      $("body").on("blur", "#timesheet_duration", function () {
        ...
        if ((t = t.replace(/[^0-9:]/gi, "")).indexOf(":") > -1) {
          ...
          1 === a[0].toString().length && (a[0] = "0" + a[0]),
            1 === a[1].toString().length
              ? (a[1] = "0" + a[1])
              : 0 === a[1].toString().length && (a[1] = "00"),
            (t = a[0] + ":" + a[1]);
      ...
      $("body").on("click", ".timesheet-toggle-enter-type", function (e) {
        ...
        $(this).find("span").not(t).removeClass("hide").addClass("switch-to"),
          $(".timesheet-start-end-time, .timesheet-duration").toggleClass(
            "hide"
          ),
      ...
      $("body").on("hidden.bs.modal", ".modal-reminder", function (e) {
        ...
        t
          .find("form")
          .attr("action", admin_url + "misc/add_reminder/" + a + "/" + i),
      ...
      $("body").on("shown.bs.modal", ".modal-reminder", function (e) {
        0 == $(this).find('form[data-edit="true"]').length &&
      ...
      $("body").on("change", ".task-single-inline-field", function () {
        ...
        $.each(e, function () {
          ...
          "startdate" == e && "" === a
            ...
            : "startdate" == e && "" !== a && i.removeClass("text-danger"),
            (("startdate" == e && "" !== a) || "startdate" != e) &&
              ((t[$(this).attr("name")] = a),
              "startdate" != e && "" === a
                ? i.css("opacity", 0.5)
                : i.css("opacity", 1));
      ...
      $("body").on(
        "change",
        "#task-modal #checklist_items_templates",
        function () {
          var e = $(this).val(),
            t = $(this)
              .find('option[value="' + e + '"]')
      ...
      $("[data-can-view-own], [data-can-view]").on("change", function () {
        ...
        (view_chk_selector = $(this)
          ...
          1 != view_chk_selector.data("not-applicable") &&
            (view_chk_selector.prop("checked", !1),
      ...
      $("body").on("click", ".task-single-add-timesheet", function (e) {
        ...
        var t = $("body").find(
          ...
          o = i.val();
        if (
          ("" === n && t.parents(".form-group").addClass("has-error"),
      ...
      $("body").on("click", ".copy_task_action", function () {
        ...
        return (
          ...
          (e.copy_task_assignees = $("body")
            .find("#copy_task_assignees")
            .prop("checked")),
          (e.copy_task_followers = $("body")
            .find("#copy_task_followers")
            .prop("checked")),
          (e.copy_task_checklist_items = $("body")
            .find("#copy_task_checklist_items")
            .prop("checked")),
          (e.copy_task_attachments = $("body")
            .find("#copy_task_attachments")
            .prop("checked")),
          (e.copy_task_status = $("body")
      ...
      $("body").on("shown.bs.modal", "#_task_modal", function (e) {
        $(e.currentTarget).hasClass("edit")
          ? "" !== $(this).find(".tinymce-task").val().trim() &&
      ...
      $("body").on("hide.bs.modal", "#task-modal", function () {
        ...
        "undefined" != typeof taskAttachmentDropzone &&
      ...
      $("body").on("hide.bs.modal", "#task-modal", function (e) {
        tinymce.get().forEach(function (t) {
          t.id.includes("task_comment") &&
            "" !== t.getContent() &&
            $(t.editorContainer).is(":visible") &&
            e.preventDefault();
        });
      }),
      $("body").on("hide.bs.modal", "#task-modal", function (e) {
        var t = $("#task-modal");
        if (
          (t.find(".timesheet-edit").is(":visible") && e.preventDefault(),
      ...
      $("body").on(
        "blur",
        "#task-modal ul.tagit li.tagit-new input",
        function () {
          setTimeout(function () {
      ...
      $("body").on("change", 'select[name="select-assignees"]', function () {
        ...
        (e.assignee = $('select[name="select-assignees"]').val()),
          "" !== e.assignee &&
            ...
            $.post(admin_url + "tasks/add_task_assignees", e).done(function (
              e
            ) {
              $("body").find(".dt-loader").remove(),
                (e = JSON.parse(e)),
      ...
      $("body").on("change", 'select[name="select-followers"]', function () {
        ...
        (e.follower = $('select[name="select-followers"]').val()),
          "" !== e.follower &&
            ((e.taskid = $(this).attr("data-task-id")),
            $("body").append('<div class="dt-loader"></div>'),
            $.post(admin_url + "tasks/add_task_followers", e).done(function (
              e
            ) {
              (e = JSON.parse(e)),
                $("body").find(".dt-loader").remove(),
      ...
      $("body").on("show.bs.modal", "#task-tracking-stats-modal", function () {
        ...
        setTimeout(function () {
          "undefined" != typeof taskTrackingChart &&
      ...
      "undefined" != typeof openLeadID &&
        "" !== openLeadID &&
        init_lead(openLeadID, !!get_url_param("edit")),
      ...
      $("body").on("click", "[lead-edit]", function (e) {
        ...
        if (
          ...
          var a = $("#lead-modal").find("#address"),
            i = a[0].scrollHeight;
          a.is("textarea") &&
            (a.height(0).height(i - 15), a.css("padding-top", "9px"));
        }
      }),
      ...
      $("body").on("change", "input.include_leads_custom_fields", function () {
        ...
        2 == e
          ? $("#merge_db_field_" + t).removeClass("hide")
          : $("#merge_db_field_" + t).addClass("hide"),
          3 == e
            ? $("#merge_db_contact_field_" + t)
            : $("#merge_db_contact_field_" + t).addClass("hide");
      }),
      ...
      var o = {
          ...
          function (e, t, a) {
            ...
            return (
              ...
              $.getJSON(
                ...
                $.extend({}, i, { start: e.startStr, end: e.endStr })
              ).then(function (e) {
                t(
                  e.map(function (e) {
                    return $.extend({}, e, {
        ...
        dateClick: function (e) {
          ...
          var t = new DateFormatter().formatDate(
            new Date(e.dateStr),
            (vformat =
              24 == app.options.time_format
                ? app.options.date_format + " H:i"
                : app.options.date_format + " g:i A")
          );
          return (
            $("input[name='start'].datetimepicker").val(t),
      ...
      if (
        ...
        1 == app.user_is_staff_member &&
          ("" !== app.options.google_api &&
            (o.googleCalendarApiKey = app.options.google_api),
          "" !== app.calendarIDs &&
    ...
    $("body").on("change", 'select[name="tax"]', function () {
      ...
      $("body").on("click", "#invoice_create_credit_note", function (e) {
        ...
        t.modal("show"),
          t
            .find("#confirm-invoice-credit-note")
            ...
            i < a
              ? ($(".credits-table").before(
                  $("<div/>", {
                    ...
                    app.lang
                      .credit_amount_bigger_then_credit_note_remaining_credits
                  )
                ),
                e.find('[type="submit"]').prop("disabled", !0))
              : (e.find(".credit-note-balance-due").html(format_money(i - a)),
          ...
          $.each(t, function () {
            ...
            a > i
              ? ($(".credits-table").before(
                ...
                e.find('[type="submit"]').prop("disabled", !0))
              : (e.find(".invoice-balance-due").html(format_money(i - a)),
                e.find('[type="submit"]').prop("disabled", !1));
        }
      ),
      $('input[name="notify_type"]').on("change", function () {
        var e = $('input[name="notify_type"]:checked').val(),
          ...
          a = $("#role_notify");
        "specific_staff" == e
          ? (t.removeClass("hide"), a.addClass("hide"))
          : "roles" == e
          ? (t.addClass("hide"), a.removeClass("hide"))
          : "assigned" == e && (t.addClass("hide"), a.addClass("hide"));
      }),
      $("body").on("shown.bs.modal", "#lead-modal", function (e) {
        custom_fields_hyperlink(),
          0 === $("body").find('#lead-modal input[name="leadid"]').length &&
            $("body").find('#lead-modal input[name="name"]').focus(),
          init_tabs_scrollable(),
          $("body").find(".lead-wrapper").hasClass("open-edit") &&
            $("body").find("a[lead-edit]").click();
      }),
      $("body").on("show.bs.modal", "#lead-modal", function (e) {
        0 == $("#lead-more-dropdown").find("li").length &&
          $("#lead-more-btn")
            .css("display", "none")
      ...
      $("body").on("click", '#lead-modal a[data-toggle="tab"]', function () {
        "#tab_lead_profile" == this.hash ||
        "#attachments" == this.hash ||
        "#lead_notes" == this.hash ||
        "#gdpr" == this.hash ||
        "#lead_activity" == this.hash
    ...
    if (
      ...
      $(".bulk_actions").on("change", 'input[name="mass_delete"]', function () {
        var e = $("#bulk_change");
        !0 === $(this).prop("checked")
          ? (e.find("select").selectpicker("val", ""),
            e.addClass("hide"),
            $(".mass_delete_separator, merge_tickets_checkbox").addClass(
              "hide"
            ),
            $("#merge_tickets").prop("checked", !1))
          : (e.removeClass("hide"),
            $(".mass_delete_separator, merge_tickets_checkbox").removeClass(
              "hide"
            ));
      }),
      ...
      $("body").on("shown.bs.modal", "#__todo", function () {
        ...
        e.find('textarea[name="description"]').focus(),
          "" !== e.find('input[name="todoid"]').val()
            ? (e.find(".add-title").addClass("hide"),
              e.find(".edit-title").removeClass("hide"))
            : (e.find(".add-title").removeClass("hide"),
              e.find(".edit-title").addClass("hide"));
      }),
      $("#top_search_button button").on("click", function () {
        var e = $("#search_input");
        $(this).hasClass("search_remove") &&
          ($(this)
            .html('<i class="fa fa-search"></i>')
            .removeClass("search_remove"),
          (original_top_search_val = ""),
      ...
      $("body").click(function (e) {
        $(e.target)
          .parents("#top_search_dropdown")
          .hasClass("search-results") || $("#top_search_dropdown").remove();
      }),
      ...
      $(".btn-import-submit").on("click", function () {
        $(this).hasClass("simulate") &&
          $("#import_form").append(hidden_input("simulate", !0)),
          $("#import_form").submit();
      }),
      ...
      $(".open-customizer").on("click", function (e) {
        e.preventDefault(),
          setup_menu.hasClass(
            "true" == isRTL ? "fadeOutRight" : "fadeOutLeft"
          ) &&
            setup_menu.removeClass(
              "true" == isRTL ? "fadeOutRight" : "fadeOutLeft"
            ),
          setup_menu.addClass(
            "display-block " + ("true" == isRTL ? "fadeInRight" : "fadeInLeft")
          ),
      ...
      $("body").on("click", ".cpicker", function () {
        ...
        $(this)
          ...
          $(this).hasClass("kanban-cpicker")
            ...
            : $(this).hasClass("calendar-cpicker") &&
              $("body").find('._event input[name="color"]').val(e);
      }),
      ...
      $("body").on(
        ...
        function (e) {
          ...
          var t,
            a = $(this),
            i = a.hasClass("notification_link")
              ? a.data("link")
          ...
          if (n[1] && n[1].indexOf("=") > -1)
            if (
              ((s = !1), (t = n[1].split("=")[1]), n[1].indexOf("postid") > -1)
            )
              (postid = t),
                $(window).width() > 769
              ...
              n[1].indexOf("leadid") > -1
                ? init_lead(t)
                : n[1].indexOf("eventid") > -1 && view_event(t);
          a.hasClass("desktopClick") ||
            a.parent("li").find(".not-mark-as-read-inline").click(),
            s &&
              setTimeout(function () {
      ...
      $(".notifications-wrapper").on("show.bs.dropdown", function () {
        notifications_wrapper.find(".notifications").attr("data-total-unread") >
          0 &&
    ...
    if ((table_tasks = $(".table-tasks")).length) {
      ...
      $("body").hasClass("tasks-page") && (k += "?bulk_actions=true"),
        (_table_api = initDataTable(table_tasks, k, g, g, b, [
          table_tasks.find("th.duedate").index(),
          "asc",
        ])),
        _table_api &&
          $("body").hasClass("dashboard") &&
    ...
    $("#send_file").on("show.bs.modal", function (e) {
      ...
      $("body").on(
        "change",
        'input[name="send_set_password_email"]',
        function () {
      ...
      $("body").on("change", '.todo input[type="checkbox"]', function () {
        var e = !0 === $(this).prop("checked") ? 1 : 0,
          t = $(this).val();
        window.location.href =
          admin_url + "todo/change_todo_status/" + t + "/" + e;
      });
    ...
    y.length > 0 &&
      ...
      $("body").hasClass("estimates-pipeline") &&
        estimate_pipeline_open($('input[name="estimateid"]').val()),
      $("body").hasClass("proposals-pipeline") &&
        proposal_pipeline_open($('input[name="proposalid"]').val()),
      $("body").on("submit", "._transaction_form", function () {
        calculate_total(), $("body").find("#items-warning").remove();
        var e = $(this).find("table.items"),
          t = e.find(".main");
        return t.find('[name="description"]').length &&
          t.find('[name="description"]').val().trim().length > 0 &&
          t.find('[name="rate"]').val().trim().length > 0
          ? (e.before(
      ...
      $("body").on("click", ".transaction-submit", function () {
        ...
        t.valid() &&
          (e.hasClass("save-as-draft")
            ...
            : e.hasClass("save-and-send-later") &&
              t.append(hidden_input("save_and_send_later", "true"))),
          t.submit();
      }),
            ...
            $.post(e.attr("action"), $(e).serialize()).done(function (t) {
              e.find('textarea[name="description"]').val(""),
                e.hasClass("estimate-notes-form")
                  ...
                  : e.hasClass("contract-notes-form") &&
                    get_sales_notes(t, "contracts");
            }),
            !1
          );
      }),
      ...
      $("body").on(
        ...
        function () {
          ...
          if ((do_prefix_year(e), !($('input[name="isedit"]').length > 0))) {
            ...
            $("body").find("div.estimate").length > 0
              ? ((a = admin_url + "estimates/get_due_date"), (t = "expirydate"))
              : $("body").find("div.proposal").length > 0 &&
                ((a = admin_url + "proposals/get_due_date"), (t = "open_till")),
              "" === e && $('input[name="' + t + '"]').val(""),
              "" !== e &&
            ...
            success: function (e, t) {
              ...
              (a = "delete_" + i + "_attachment"),
                "estimate" == i
                  ...
                  : "function" == typeof window["init_" + i] &&
                    window["init_" + i](t.rel_id);
              var n = "";
              (!0 !== t.success && "true" != t.success) ||
                ((n +=
                ...
                (n +=
                  '<a href="' +
                  site_url +
                  "download/file/sales_attachment/" +
                  t.key +
                  '" target="_blank">' +
                  t.file_name +
                  "</a>"),
      ...
      $("body").on(
        "change",
        'input[name="adjustment"],select.tax',
        function () {
          calculate_total();
        }
      ),
      ...
      $("body").on("change", ".invoice #project_id", function () {
        ...
        if ("" !== e)
          requestGetJSON("tasks/get_billable_tasks_by_project/" + e).done(
            function (t) {
          ...
          "" !== t
            ? requestGetJSON(
                "tasks/get_billable_tasks_by_customer_id/" + t
              ).done(function (e) {
      ...
      $("body").on("change", ".f_client_id #clientid", function () {
        ...
        requestGetJSON(
          "invoices/client_change_data/" + e + "/" + (n = void 0 === n ? "" : n)
        ).done(function (e) {
          $("#merge").html(e.merge_info);
          var a = $("#expenses_to_bill");
          for (var n in (0 === a.length
            ? (e.expenses_bill_info = "")
            : a.html(e.expenses_bill_info),
          "" !== e.merge_info || "" !== e.expenses_bill_info
          ...
          billingAndShippingFields))
            billingAndShippingFields[n].indexOf("billing") > -1 &&
              (billingAndShippingFields[n].indexOf("country") > -1
                ? $(
                    'select[name="' + billingAndShippingFields[n] + '"]'
                  ).selectpicker(
                    "val",
                    e.billing_shipping[0][billingAndShippingFields[n]]
                  )
                : billingAndShippingFields[n].indexOf("billing_street") > -1
                ? $('textarea[name="' + billingAndShippingFields[n] + '"]').val(
                    e.billing_shipping[0][billingAndShippingFields[n]]
                  )
                : $('input[name="' + billingAndShippingFields[n] + '"]').val(
                    e.billing_shipping[0][billingAndShippingFields[n]]
                  ));
          for (var s in (empty(e.billing_shipping[0].shipping_street) ||
            $('input[name="include_shipping"]').prop("checked", !0).change(),
          billingAndShippingFields))
            billingAndShippingFields[s].indexOf("shipping") > -1 &&
              (billingAndShippingFields[s].indexOf("country") > -1
                ? $(
                    'select[name="' + billingAndShippingFields[s] + '"]'
                  ).selectpicker(
                    "val",
                    e.billing_shipping[0][billingAndShippingFields[s]]
                  )
                : billingAndShippingFields[s].indexOf("shipping_street") > -1
                ? $('textarea[name="' + billingAndShippingFields[s] + '"]').val(
                    e.billing_shipping[0][billingAndShippingFields[s]]
                  )
                : $('input[name="' + billingAndShippingFields[s] + '"]').val(
                    e.billing_shipping[0][billingAndShippingFields[s]]
                  ));
          init_billing_and_shipping_details();
      ...
      0 === $("body").find('input[name="isedit"]').length &&
        $('.f_client_id select[name="clientid"]').change(),
      $("body").on(
        "click",
        "#get_shipping_from_customer_profile",
        function (e) {
          e.preventDefault();
          var t = $("#include_shipping");
          !1 === t.prop("checked") &&
            (t.prop("checked", !0), $("#shipping_details").removeClass("hide"));
          var a = $("#clientid").val();
          "" !== a &&
            requestGetJSON(
              "clients/get_customer_billing_and_shipping_details/" + a
            ).done(function (e) {
          ...
          ? requestGetJSON("invoices/get_merge_data/" + t).done(function (e) {
              $.each(e.items, function (e, a) {
                "" !== a.rel_type &&
                  ("task" == a.rel_type
                    ? $('input[name="task_id"]').val(
                        a.item_related_formatted_for_input
                      )
                    : "expense" == a.rel_type &&
                      $('input[name="expense_id"]').val(
                        a.item_related_formatted_for_input
      ...
      $("body").on("change", 'input[name="bill_expenses[]"]', function () {
        var e = $(this).prop("checked"),
          t = $(this).val();
        !0 === e
          ? requestGetJSON("invoices/get_bill_expense_data/" + t).done(
              function (e) {
        ...
        function () {
          ...
          (current_desc_val = a.val()),
            ...
            "" !== t &&
              (!0 === $(this).prop("checked")
                ? ((e = current_desc_val + "\n" + t), a.val(e.trim()))
                : (a.val(current_desc_val.replace("\n" + t, "")),
  ...
  $("#newsfeed").scroll(function (e) {
    ...
    t[0].scrollHeight - t.scrollTop() == t.outerHeight() && load_newsfeed(),
      $("#newsfeed .close_newsfeed").css(
        "top",
        $(this).scrollTop() + 20 + "px"
      );
  });
