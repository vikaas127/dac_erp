...
var ITEM_ALLOWANCE_CACHE={};function get_item_allowance(itemId){if(ITEM_ALLOWANCE_CACHE[itemId]){return $.Deferred().resolve(ITEM_ALLOWANCE_CACHE[itemId])}
...
$("body").on("change",'input[name="additional_discount"]',function(){calculate_total()})
