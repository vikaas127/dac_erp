...
$(document).ready(function () {
    ...
    function movePreviewRow() {
        if (window.innerWidth <= 760) {
            var tbody = $('.estimate-items-table tbody');
            var mainRow = tbody.find('tr.main');

            // move preview row to bottom
    ...
    // also run on resize (important)
    $(window).on('resize', function () {
        movePreviewRow();
    });

});
function add_item_to_preview(e,t=null){requestGetJSON("invoice_items/get_item_by_id/"+e+(t?"/"+t:"")).done(function(e){

     /* ✅ MOBILE: skip preview completely */
        if (window.innerWidth <= 760) {

           var data = {
                description: e.description,
                long_description: e.long_description.replace(/(<|&lt;)br\s*\/*(>|&gt;)/g, " "),
                rate: e.rate,
                qty: 1,
                item_id: e.itemid,
                
                // 🔥 FIX HERE
                item_discount_percent: (e.item_discount != null && e.item_discount !== '')
                    ? String(e.item_discount)
                    : '0',

                item_original_discount_percent: (e.item_discount != null && e.item_discount !== '')
                    ? String(e.item_discount)
                    : '0',
